...
const CreateFolderModal = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl shadow-2xl border border-white/20 max-w-lg w-full max-h-[85vh] flex flex-col overflow-hidden">
        {/* Header - Fixed */}
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6 modal-scrollbar">
          ...
          <div>
            ...
            <div className="bg-white/5 rounded-xl p-3 max-h-60 overflow-y-auto border border-white/10 modal-tree-scrollbar">
              {/* Root Level Option */}
              <div
        ...
        <div className="flex space-x-4 p-6 border-t border-white/10 flex-shrink-0">
          <button
            onClick={onClose}
